...
var Mouse = function(){
	...
	me.up = function(event){
		...
		//gameObjects.mouseUp();
		if(localPlayer !== null) input.add(localPlayer.index, MOUSE_UP, me.x, me.y, me.rawX, me.rawY, me.leftDown, me.rightDown, keyboard.isDown(CHAR_TO_KEYCODE["Ctrl"]), keyboard.isDown(CHAR_TO_KEYCODE["Shift"]));
	};
	...
	me.down = function(event){
		...
		if(localPlayer !== null) input.add(localPlayer.index, MOUSE_DOWN, me.x, me.y, me.rawX, me.rawY, me.leftDown, me.rightDown, keyboard.isDown(CHAR_TO_KEYCODE["Ctrl"]), keyboard.isDown(CHAR_TO_KEYCODE["Shift"]));
	};
	...
	me.move = function(event){
		...
		if(localPlayer !== null) input.add(localPlayer.index, MOUSE_MOVE, me.x, me.y, me.rawX, me.rawY, me.leftDown, me.rightDown, keyboard.isDown(CHAR_TO_KEYCODE["Ctrl"]), keyboard.isDown(CHAR_TO_KEYCODE["Shift"]));
	};
